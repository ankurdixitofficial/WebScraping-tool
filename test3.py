...
def page_state():
    for i in range(1,4):
        return(i)
    for j in range(1,36):
        states={1:'Andaman And Nicobar Islands', 2:'Andhra Pradesh', 3:'Arunachal Pradesh', 4:'Assam', 5:'Bihar', 6:'Chandigarh', 7:'Chhattisgarh', 8:'Dadra And Nagar Haveli',9:'Delhi',10:'Goa',11:'Gujarat',12:'Haryana',13:'Himachal Pradesh',14:'Jammu And Kashmir',15:'Jharkhand',16:'Karnataka',17:'Kerala',18:'Ladakh',19:'Madhya Pradesh',20:'Maharashtra',21:'Manipur',22:'Meghalaya',23:'Mizoram',24:'Nagaland',25:'Odisha',26:'Puducherry',27:'Punjab',28:'Rajasthan',29:'Sikkim',30:'Tamil Nadu',31:'Telangana',32:'Tripura',33:'Uttar Pradesh',34:'Uttarakhand',35:'West Bengal'}
        state=states[j]
        print(state)
        return state
    c=extract(i,state)
